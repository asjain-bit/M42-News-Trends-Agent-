# News & Trends Agent — Design System & Structure Reference
...
**`ScreenId` values:** `dashboard`, `components`, `themes`, `news-sources`, `news-collection-status`, `settings`, `weekly-news-digest`.
...
<IconButton label="Delete Alert" className="icon-button--danger"><Icon name="trash" /></IconButton>
```
| Prop | Type | Notes |
|---|---|---|
...
<StatCard label="Total Articles" value="1,240" icon="rss"
...
<Loading height={120}>Fetching Latest News…</Loading>
```
| Prop | Type | Default |
|---|---|---|
...
<AiScanLoader title="Scanning document…" subtitle="Applying AI Insights" />
```
| Prop | Type | Default |
|---|---|---|
| `title` | `string` | `'Scanning document…'` |
| `subtitle` | `string` | `'Applying AI Insights'` |
...
<SidePanel open={open} width="lg" title="Article Details"
...
<ConfirmDialog open={open} tone="danger" icon="trash" title="Remove Saved Article?"
...
├── .app-sidebar__brand
│   ├── .app-sidebar__logo                "News & Trends Agent"
